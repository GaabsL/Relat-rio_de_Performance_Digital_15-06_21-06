        ...
        <div className="relative w-full h-[400px] bg-slate-50 border border-slate-200 rounded flex items-center justify-center overflow-hidden overflow-x-auto">
          <div className="relative min-w-[700px] w-full h-full">
            ...
            <svg className="absolute inset-0 w-full h-full pointer-events-none">
               ...
               <line x1="50%" y1="50%" x2="20%" y2="25%" stroke="#CBD5E1" strokeWidth="2" strokeDasharray="4 4" />
               <line x1="50%" y1="50%" x2="80%" y2="25%" stroke="#CBD5E1" strokeWidth="2" strokeDasharray="4 4" />
               <line x1="50%" y1="50%" x2="15%" y2="50%" stroke="#CBD5E1" strokeWidth="2" strokeDasharray="4 4" />
               <line x1="50%" y1="50%" x2="85%" y2="50%" stroke="#CBD5E1" strokeWidth="2" strokeDasharray="4 4" />
               <line x1="50%" y1="50%" x2="30%" y2="75%" stroke="#CBD5E1" strokeWidth="2" strokeDasharray="4 4" />
               <line x1="50%" y1="50%" x2="70%" y2="75%" stroke="#CBD5E1" strokeWidth="2" strokeDasharray="4 4" />
            </svg>
